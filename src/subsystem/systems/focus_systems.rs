use hecs::Entity;
use log::debug;
use crate::subsystem::components::{Hide, HidePropagated};
use crate::subsystem::components::ui::UiFocusable;
use crate::subsystem::resources::inputs::types::{Input, KeyCode};
use crate::subsystem::world::{GameData, SubWorld, World};
