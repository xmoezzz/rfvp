...
#[repr(C)]
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub struct RawAudioStreamDesc {
    pub sample_rate: u32,
    pub channels: u16,
    pub sample_format: RawAudioSampleFormat,
}
...
pub type RawCreateAudioStreamFn =
    unsafe extern "C" fn(ctx: *mut c_void, stream_id: u32, desc: RawAudioStreamDesc) -> i32;

pub type RawSubmitI16Fn = unsafe extern "C" fn(
    ctx: *mut c_void,
    stream_id: u32,
    samples: *const i16,
    sample_count: usize,
...
pub type RawSubmitF32Fn = unsafe extern "C" fn(
    ctx: *mut c_void,
    stream_id: u32,
    samples: *const f32,
    sample_count: usize,
...
pub type RawPlayAudioFn =
    unsafe extern "C" fn(ctx: *mut c_void, stream_id: u32, params: RawAudioParams) -> i32;

pub type RawStopAudioFn =
    unsafe extern "C" fn(ctx: *mut c_void, stream_id: u32, fade_ms: u32) -> i32;

pub type RawSetAudioParamsFn =
    unsafe extern "C" fn(ctx: *mut c_void, stream_id: u32, params: RawAudioParams) -> i32;

pub type RawDestroyAudioStreamFn = unsafe extern "C" fn(ctx: *mut c_void, stream_id: u32);
...
pub struct RawAudioVTable {
    pub create_stream: RawCreateAudioStreamFn,
    pub submit_i16: RawSubmitI16Fn,
    pub submit_f32: RawSubmitF32Fn,
    pub play: RawPlayAudioFn,
    pub stop: RawStopAudioFn,
    pub set_params: RawSetAudioParamsFn,
    pub destroy_stream: RawDestroyAudioStreamFn,
