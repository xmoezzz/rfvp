...
use crate::status::{status_to_result, WiiStatus};

pub struct WiiFileSystem {
    ctx: *mut c_void,
...
impl RfvpFileSystem for WiiFileSystem {
    type File = WiiFile;
...
unsafe extern "C" fn enumerate_visitor_bridge(
    ...
    let path = match core::str::from_utf8(path_bytes) {
        Ok(value) => value,
        Err(_) => return WiiStatus::InvalidData.as_i32(),
    };
