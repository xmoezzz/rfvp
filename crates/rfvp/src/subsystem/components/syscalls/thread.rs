...
pub fn thread_exit(game_data: &mut GameData, id: &Variant) -> Result<Variant> {
    ...
    game_data.thread_wrapper.thread_exit(id);
    Ok(Variant::Nil)
}
...
pub fn thread_raise(game_data: &mut GameData, time: &Variant) -> Result<Variant> {
    ...
    game_data.thread_wrapper.thread_raise(time);
...
pub fn thread_sleep(game_data: &mut GameData, time: &Variant) -> Result<Variant> {
    ...
    game_data.thread_wrapper.thread_sleep(time);
...
pub fn thread_wait(game_data: &mut GameData, time: &Variant) -> Result<Variant> {
    ...
    game_data.thread_wrapper.thread_wait(time as u32);
    Ok(Variant::Nil)
}
