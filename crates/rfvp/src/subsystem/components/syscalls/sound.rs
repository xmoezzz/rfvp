...
pub fn audio_silent_on(game_data: &mut GameData, channel: &Variant) -> Result<Variant> {
    ...
    game_data.bgm_player_mut().silent_on(channel, Tween::default());
    Ok(Variant::Nil)
}
...
pub fn audio_vol_legacy_aw(
    ...
    game_data
        .bgm_player_mut()
        .set_volume(channel, vol as f32, Tween::default());
...
pub fn sound_silent_on(game_data: &mut GameData, channel: &Variant) -> Result<Variant> {
    ...
    game_data.se_player_mut().silent_on(channel, Tween::default());
    Ok(Variant::Nil)
}
...
pub fn sound_volume_legacy_aw(
    ...
    game_data
        .se_player_mut()
        .set_volume(channel, volume as f32 / 100.0, Tween::default());
